...
/*!re2c /* */
	...
	pavles	 = [\u002D\u2010\u2011];
	punct	  = P ;
	letter = Lu | Ll | Lt | M | Lm | Cf | Lo; //we exclude Lo and Lm
	currency   = Sc;
	symbol	 = S ; // we include Lo Lm here
	whitespace = Z | Cc;
	...
	email_char = [a-zA-Z0-9_\-\.];
	// should we include mailto?
	email = "mailto:"? @email_before_at_start  (email_char \ ".") email_char+ @email_before_at_end 
		("@" | "&#64;" | "%40" | (" "* ("(" | "[") " "* 'at' " "* (")" | "]") " "*))
		@email_after_at_start   (email_char \ ".") email_char* @email_after_at_end 
		("." | "&#46;" | (" "* ("(" | "[" | " ") " "* 'dot' " "* (")" | "]"  | " ") " "*))
		@email_after_dot_start [a-z] [a-z]+ @email_after_dot_end;
	...
	date = (day [.] month [.] year_full) | (year_full [.] month [.] day) | (month [.] day [.] year_full) //we use full to reduce false positives
